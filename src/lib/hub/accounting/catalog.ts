...
export const accountingAccountCatalog: CatalogAccount[] = [
  ...
  account("2614", "Utgående moms omvänd skattskyldighet, 25 %", "liability", "Moms", ["omvänd moms", "eu inköp"]),
  account("2615", "Utgående moms import av varor, 25 %", "liability", "Moms", ["importmoms"]),
  account("2621", "Utgående moms på försäljning, 12 %", "liability", "Moms", ["moms 12"]),
  account("2624", "Utgående moms omvänd skattskyldighet, 12 %", "liability", "Moms", ["omvänd moms"]),
  account("2625", "Utgående moms import av varor, 12 %", "liability", "Moms", ["importmoms"]),
  account("2631", "Utgående moms på försäljning, 6 %", "liability", "Moms", ["moms 6"]),
  account("2634", "Utgående moms omvänd skattskyldighet, 6 %", "liability", "Moms", ["omvänd moms"]),
  account("2635", "Utgående moms import av varor, 6 %", "liability", "Moms", ["importmoms"]),
  ...
  account("3105", "Försäljning varor utanför EU", "income", "Export", ["export", "utanför eu"]),
  account("3106", "Försäljning varor till annat EU-land", "income", "EU-försäljning", ["eu"]),
  account("3107", "Överföring av varor till annat EU-land", "income", "EU-försäljning", ["eu överföring"]),
  account("3108", "Mellanmans inköp och försäljning vid trepartshandel", "income", "EU-försäljning", ["trepartshandel"]),
  account("3231", "Försäljning inom byggsektorn, omvänd skattskyldighet", "income", "Omvänd moms", ["bygg", "omvänd moms"]),
  account("3305", "Försäljning tjänster utanför EU", "income", "Export", ["export tjänst", "utanför eu"]),
  ...
  account("4545", "Import av varor, beskattningsunderlag", "expense", "Varor och material", ["import"]),
