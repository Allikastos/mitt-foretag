...
select has_column('public', 'integration_connections', 'category', 'connections have categories');
select has_column('public', 'integration_connections', 'configuration_version', 'connections track configuration versions');
select has_column('public', 'integration_connections', 'health_status', 'connections track health');
select has_column('public', 'external_event_receipts', 'external_event_id', 'receipts identify external events');
select has_column('public', 'external_event_receipts', 'payload_sha256', 'receipts store payload hashes');
select has_column('public', 'external_event_receipts', 'attempt_count', 'receipts track attempts');
select has_column('public', 'external_event_receipts', 'failure_code', 'receipts track safe failure codes');
select hasnt_column('public', 'integration_connections', 'secret', 'connections do not store secrets');
select hasnt_column('public', 'external_event_receipts', 'payload', 'receipts do not store raw payloads');
