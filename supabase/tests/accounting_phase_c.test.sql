...
select has_column('public', 'business_events', 'client_request_key');
select has_column('public', 'business_events', 'request_hash');
select has_column('public', 'bookkeeping_drafts', 'approved_by');
select has_column('public', 'bookkeeping_drafts', 'approved_at');
