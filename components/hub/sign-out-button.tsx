  ...
  return (
    <button
      ...
      className={
        compact
          ? isCollapsed
            ? "flex h-11 w-full items-center justify-center rounded-[1rem] text-sm font-medium text-[var(--hub-panel-muted)] transition hover:bg-[var(--hub-panel-hover)] hover:text-[var(--hub-panel-contrast)] disabled:cursor-not-allowed disabled:opacity-60"
            : "text-sm text-[var(--hub-panel-muted)] transition hover:text-[var(--hub-panel-contrast)] disabled:cursor-not-allowed disabled:opacity-60"
